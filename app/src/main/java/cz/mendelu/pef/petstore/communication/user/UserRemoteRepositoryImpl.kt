...
class UserRemoteRepositoryImpl
    @Inject constructor(private val userAPI: UserAPI) : IUserRemoteRepository {

    override suspend fun login(username: String, password: String): CommunicationResult<LoginResponse> =
